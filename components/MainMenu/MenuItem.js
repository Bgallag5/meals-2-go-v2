...
export default function MenuItem(props) {
  ...
  return (
    <div data-category={category} className="menu-item relative flex flex-row gap-6 h-auto min-h-[10rem] lg:min-h-0 lg:h-32 bg-white w-full group ">
      ...
      <div className="flex flex-col gap-2 justify-center w-32 h-full my-auto p-1 mx-2">
