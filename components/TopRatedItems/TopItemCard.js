...
export default function TopItemCard({item}) {
  ...
  return (
    ...
    <div onClick={() => showItemModal(item)} data-price={priceIcon.length} className=" group top-menu-item cursor-pointer  h-64 lg:h-72 w-4/5 sm:w-1/2 md:w-1/3 lg:w-1/4 relative bg-cover rounded-md overflow-hidden shadow-lg">
      <Image alt={"top-item"} loading={'lazy'} className="skeleton object-cover top-menu-img" layout="fill" src={require(`../../assets/images/${image}`)}/>
